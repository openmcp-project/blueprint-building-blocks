...
pushSecret: "openmcp-test": {
	// Source: external-secrets-config/templates/push-secret.yaml
	...
	spec: {
		...
		selector: {
			...
			secret: name: "pokedex-credentials"
		}
		template: {
			data: "best-pokemon": "{{ .best-pokemon | toString | upper }} is the really best!"
			metadata: {
				annotations: {}
				labels: {}
			}
