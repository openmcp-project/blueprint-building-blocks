...
![Version: 0.0.14](https://img.shields.io/badge/Version-0.0.14-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.21.0](https://img.shields.io/badge/AppVersion-0.21.0-informational?style=flat-square)
...
* <https://doc.crds.dev/github.com/crossplane-contrib/provider-helm/helm.crossplane.io/ProviderConfig/v1beta1>
* <https://doc.crds.dev/github.com/crossplane-contrib/provider-helm/helm.crossplane.io/Release/v1beta1>
...
| providerConfigs | list | list | providerConfigs contains ProviderConfig resources for the crossplane provider-helm (helm.crossplane.io/v1beta1). Each entry creates a ProviderConfig that provider-helm uses to connect to a target Kubernetes cluster. |
| providerConfigs[0] | object | `{"name":"","spec":{"credentials":{"secretRef":{"key":"kubeconfig","name":"","namespace":"crossplane-system"},"source":"Secret"}}}` | name is the metadata.name of the ProviderConfig resource. |
| providerConfigs[0].spec.credentials.secretRef | object | `{"key":"kubeconfig","name":"","namespace":"crossplane-system"}` | secretRef references the Kubernetes secret that contains the kubeconfig for the target cluster. |
| providerConfigs[0].spec.credentials.source | string | `"Secret"` | source of credentials. Typically "Secret" referencing a kubeconfig secret. |
