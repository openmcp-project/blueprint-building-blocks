...
![Version: 0.0.16](https://img.shields.io/badge/Version-0.0.16-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.18.0](https://img.shields.io/badge/AppVersion-0.18.0-informational?style=flat-square)
...
* <https://doc.crds.dev/github.com/crossplane-contrib/provider-kubernetes/kubernetes.crossplane.io/ObservedObjectCollection/v1alpha2@v0.18.0>

## Values

| Key | Type | Default | Description |
|-----|------|---------|-------------|
| defaults.object.deletionPolicy | string | `"Delete"` |  |
...
| observedObjectCollections | list | [] | [observedObjectCollections](https://doc.crds.dev/github.com/crossplane-contrib/provider-kubernetes/kubernetes.crossplane.io/ObservedObjectCollection/v1alpha2) discovers and observes a dynamic collection of Kubernetes objects matching a label selector, creating Object resources for each. |
| observedObjectCollections[0].namespaceSelector | object | `{}` | namespaceSelector optionally restricts observation to specific namespaces. |
| observedObjectCollections[0].observeObjects | object | `{}` | observeObjects configures the label selector to filter which objects to observe. |
| observedObjectCollections[0].providerConfigRefName | string | `""` | providerConfigRefName references the ProviderConfig used to access the target cluster. |
| observedObjectCollections[0].resourceRef | object | `{}` | resourceRef specifies the type of resources to observe (apiVersion + resource/kind). |
| observedObjectCollections[0].template | object | `{}` | template optionally defines extra fields to merge into each generated Object. |
